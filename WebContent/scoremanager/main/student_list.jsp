			...
			<form method="get">
				<div class="row border mx-3 mb-3 py-2 align-items-center rounded" id="filter">
					<div class="col-4">
						...
						<select class="form-select" id="student-fl-select" name="f1">
							...
							<c:forEach var="year" items="${ent_year_set}">
								<%-- 現在のnumと選択されたf1が一致していた場合selectedを追記 --%>
					...
					<div class="col-4">
						...
						<select class="form-select" id="student-f3-select" name="f2">
							...
							<c:forEach var="num" items="${class_num_set}">
								<%-- 現在のnumと選択されたf2が一致してbいた場合selectedを追記 --%>
					...
					<div class="col-2 text-center">
						<button class="btn btn-secondary" id="filter-burron">絞込み</button>
					</div>
					<div class="btn text-warning">${errors.get("f1")}</div>
				</div>
			</form>
			<c:choose>
